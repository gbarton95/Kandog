        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 mb-0">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 container-fluid"> <!--Contenedor blanco-->
                    <div class="row justify-center mb-0 pb-0">
                ...
                <div class="px-6 pb-4 container-fluid">
                    <div class="row">
                            ...
                            <div class="offset-1">
                                ...
                                @if(!empty($sesionesProximas) && count($sesionesProximas) > 0) 
                                    <span style="font-size: 2rem;">{{__('Your next session is on ')}}{{$proxDiaSesion}} 
                                        {{__('at')}} {{$proxHoraSesion}}h {{__('with')}} <a href="{{ route('perro.show', $sesionesProximas[0]->perro->id) }}" class="clickme">{{$sesionesProximas[0]->perro->nombre}}</a></span> 
                                @endif
                            </div>
                            @endif
                        </div>
